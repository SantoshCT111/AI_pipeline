    ...
    classrooms_data = [
        {
            ...
            "topics": [
                {"topic": "Brüche", "accuracy": 61.0, "status": "Needs review"},
                {"topic": "Geometrie", "accuracy": 84.0, "status": "Stable"},
                {"topic": "Textaufgaben", "accuracy": 73.0, "status": "Improving"},
            ],
        },
        {
            "subject": "Natur",
            "grade": "Klasse 3",
            "section": "A",
            "metrics": {"avg_score": 82.0, "completion_rate": 88.0, "students_count": 28},
            "topics": [
                {"topic": "Zellen", "accuracy": 79.0, "status": "Stable"},
                {"topic": "Energie", "accuracy": 68.0, "status": "Improving"},
            ],
        },
        {
            "subject": "Sprache",
            "grade": "Klasse 3",
            "section": "A",
            "metrics": {"avg_score": 74.0, "completion_rate": 85.0, "students_count": 28},
            "topics": [
                {"topic": "Leseverstehen", "accuracy": 71.0, "status": "Improving"},
                {"topic": "Grammatik", "accuracy": 66.0, "status": "Needs review"},
            ],
        },
        {
            "subject": "Kunst",
            "grade": "Klasse 3",
            "section": "A",
            "metrics": {"avg_score": 85.0, "completion_rate": 90.0, "students_count": 28},
            "topics": [
                {"topic": "Farbtheorie", "accuracy": 88.0, "status": "Stable"},
                {"topic": "Zeichnen Grundlagen", "accuracy": 82.0, "status": "Stable"},
            ],
        },
    ]
