...
from schemas.auth_schema import AuthResponse, LoginRequest, RegisterRequest, UserResponse

router = APIRouter()

JWT_SECRET = os.getenv("JWT_SECRET", "edugo-dev-secret-key-change-in-production")
JWT_ALGORITHM = "HS256"
